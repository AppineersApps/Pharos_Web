/** business_management module script */
Project.modules.business_management = {
    init: function() {
    ...
    initEvents: function(elem){
                ...
                $('#upload_drop_zone_u_profile_image').width($('#uploadify_u_profile_image').width() + 18);
                $('#uploadify_u_profile_image').fileupload({
                    url : el_form_settings.upload_form_file_url, 
name : 'u_profile_image', 
temp : 'temp_u_profile_image', 
paramName : 'Filedata', 
maxFileSize : '102400', 
acceptFileTypes : 'gif|png|jpg|jpeg|jpe|bmp|ico',
                    dropZone: $('#upload_drop_zone_u_profile_image, #upload_drop_zone_u_profile_image + .upload-src-zone'),
                    formData: {
                        'unique_name' : 'u_profile_image', 
                        'id' : $('#id').val(),
                        'type' : 'uploadify'
                    },
                    add: function(e, data) {
...
Project.modules.business_management.init();
