...
<div class="module-form-container">
    <%include file="feedback_management_business_add_strip.tpl"%>
    <div class="<%$module_name%>" data-form-name="<%$module_name%>">
        <div id="ajax_content_div" class="ajax-content-div top-frm-spacing" >
            <input type="hidden" id="projmod" name="projmod" value="feedback_management_business" />
            <!-- Page Loader -->
            ...
            <div id="scrollable_content" class="scrollable-content popup-content top-block-spacing ">
                <div id="feedback_management_business" class="frm-module-block frm-elem-block frm-stand-view">
                    <!-- Module Form Block -->
                                                ...
                                                <div class="form-row row-fluid " id="cc_sh_uq_added_at">
                                                    ...
                                                    <div class="form-row row-fluid " id="cc_sh_uq_device_type">
                                                        ...
                                                        <div class="frm-bot-btn <%$rl_theme_arr['frm_stand_action_bar']%> <%$rl_theme_arr['frm_stand_action_btn']%> popup-footer">
                                                            ...
                                                            <%/if%>
                                                            <%include file="feedback_management_business_add_buttons.tpl"%>
                                                        </div>
                                                    </div>
                                                    <div class="clear"></div>
                                                </form>
