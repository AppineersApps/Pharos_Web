...
<%include file="business_management_add_strip.tpl"%>
<div class="<%$module_name%>" data-form-name="<%$module_name%>">
<div id="ajax_content_div" class="ajax-content-div top-frm-spacing" >
<input type="hidden" id="projmod" name="projmod" value="business_management" />
<!-- Page Loader -->
...
<div id="business_management" class="frm-module-block frm-elem-block frm-stand-view">
<!-- Module Form Block -->
...
<div class="title <%$rl_theme_arr['frm_stand_titles_bar']%>"><h4><%$this->lang->line('BUSINESS_MANAGEMENT_BUSINESS_MANAGEMENT')%></h4></div>
...
<input type="file" name="uploadify_u_profile_image" id="uploadify_u_profile_image" title="<%$this->lang->line('BUSINESS_MANAGEMENT_PROFILE_IMAGE')%>" />
...
<div class="form-row row-fluid " id="cc_sh_u_business_name">
<label class="form-label span3 ">
<%$form_config['u_business_name']['label_lang']%>
</label>
<div class="form-right-div  <%if $mode eq 'Update'%>frm-elements-div<%/if%> ">
<%if $mode eq "Update"%>
<input type="hidden" class="ignore-valid" name="u_business_name" id="u_business_name" value="<%$data['u_business_name']|@htmlentities%>" />
<span class="frm-data-label">
<strong>
<%if $data['u_business_name'] neq ""%>
<%$data['u_business_name']%>
<%else%>
<%/if%>
</strong></span>
<%else%>
<input type="text" placeholder="" value="<%$data['u_business_name']|@htmlentities%>" name="u_business_name" id="u_business_name" title="<%$this->lang->line('BUSINESS_MANAGEMENT_FIRST_NAME')%>"  data-ctrl-type='textbox'  class='frm-size-medium'  />
<%/if%>
</div>
<div class="error-msg-form "><label class='error' id='u_first_nameErr'></label></div>
</div>
<div class="form-row row-fluid " id="cc_sh_u_business_type">
<label class="form-label span3 ">
<%$form_config['u_business_type']['label_lang']%>
</label>
<div class="form-right-div  <%if $mode eq 'Update'%>frm-elements-div<%/if%> ">
<%if $mode eq "Update"%>
<input type="hidden" class="ignore-valid" name="u_business_type" id="u_business_type" value="<%$data['u_business_type']|@htmlentities%>" />
<span class="frm-data-label">
<strong>
<%if $data['u_business_type'] neq ""%>
<%$data['u_business_type']%>
<%else%>
<%/if%>
</strong></span>
<%else%>
<input type="text" placeholder="" value="<%$data['u_business_type']|@htmlentities%>" name="u_business_type" id="u_business_type" title="<%$this->lang->line('BUSINESS_MANAGEMENT_LAST_NAME')%>"  data-ctrl-type='textbox'  class='frm-size-medium'  />
<%/if%>
</div>
...
<%else%>
<input type="text" placeholder="" value="<%$data['u_email']|@htmlentities%>" name="u_email" id="u_email" title="<%$this->lang->line('BUSINESS_MANAGEMENT_EMAIL')%>"  data-ctrl-type='textbox'  class='frm-size-medium'  />
<%/if%>
</div>
...
<%else%>
<input type="text" placeholder="" value="<%$data['u_mobile_no']|@htmlentities%>" name="u_mobile_no" id="u_mobile_no" title="<%$this->lang->line('BUSINESS_MANAGEMENT_MOBILE_NUMBER')%>"  data-ctrl-type='textbox'  class='frm-size-medium'  />
<%/if%>
</div>
...
<textarea class="frm-gmf-address elastic" name="gmf_autocomplete_u_address" id="gmf_autocomplete_u_address" title="<%$this->lang->line('BUSINESS_MANAGEMENT_ADDRESS')%>"><%$data['u_address']%></textarea>
</span>
</div>
...
<%else%>
<input type="text" placeholder="" value="<%$data['u_city']|@htmlentities%>" name="u_city" id="u_city" title="<%$this->lang->line('BUSINESS_MANAGEMENT_CITY')%>"  data-ctrl-type='textbox'  class='frm-size-medium'  />
<%/if%>
</div>
...
<%else%>
<input type="text" placeholder="" value="<%$data['u_state_name']|@htmlentities%>" name="u_state_name" id="u_state_name" title="<%$this->lang->line('BUSINESS_MANAGEMENT_STATE_NAME')%>"  data-ctrl-type='textbox'  class='frm-size-medium'  />
<%/if%>
</div>
...
<%else%>
<input type="text" placeholder="" value="<%$data['u_zip_code']|@htmlentities%>" name="u_zip_code" id="u_zip_code" title="<%$this->lang->line('BUSINESS_MANAGEMENT_ZIP_CODE')%>"  data-ctrl-type='textbox'  class='frm-size-medium'  />
<%/if%>
</div>
<div class="error-msg-form "><label class='error' id='u_zip_codeErr'></label></div>
</div>

<div class="form-row row-fluid " id="cc_sh_u_about_business">
<label class="form-label span3 ">
<%$form_config['u_about_business']['label_lang']%>
</label>
<div class="form-right-div  <%if $mode eq 'Update'%>frm-elements-div<%/if%> ">
<%if $mode eq "Update"%>
<input type="hidden" class="ignore-valid" name="u_about_business" id="u_about_business" value="<%$data['u_about_business']|@htmlentities%>" />
<span class="frm-data-label">
<strong>
<%if $data['u_about_business'] neq ""%>
<%$data['u_about_business']%>
<%else%>
<%/if%>
</strong></span>
<%else%>
<input type="text" placeholder="" value="<%$data['u_about_business']|@htmlentities%>" name="u_about_business" id="u_zip_code" title="<%$this->lang->line('BUSINESS_MANAGEMENT_ZIP_CODE')%>"  data-ctrl-type='textbox'  class='frm-size-medium'  />
<%/if%>
</div>
<div class="error-msg-form "><label class='error' id='u_about_businessErr'></label></div>
</div>
...
<%else%>
<input type="text" placeholder="" value="<%$data['u_terms_conditions_version']|@htmlentities%>" name="u_terms_conditions_version" id="u_terms_conditions_version" title="<%$this->lang->line('BUSINESS_MANAGEMENT_TERMS_CONDITIONS_VERSION')%>"  data-ctrl-type='textbox'  class='frm-size-medium'  />
<%/if%>
</div>
...
<%else%>
<input type="text" placeholder="" value="<%$data['u_privacy_policy_version']|@htmlentities%>" name="u_privacy_policy_version" id="u_privacy_policy_version" title="<%$this->lang->line('BUSINESS_MANAGEMENT_PRIVACY_POLICY_VERSION')%>"  data-ctrl-type='textbox'  class='frm-size-medium'  />
<%/if%>
</div>
...
<div class="form-row row-fluid " id="cc_sh_u_business_hours">
	<label class="form-label span3 ">
		Bussiness Hours
	</label>
	<div class="form-right-div">
		<span class="frm-data-label">
			...
			<%section name=j loop=$working_days%>
				<%$working_days[j]["vDay"]%> From <%$working_days[j]["vStartAt"]%> To <%$working_days[j]["vCloseAt"]%> <br>
...
<%$this->dropdown->display("u_status","u_status","  title='<%$this->lang->line('BUSINESS_MANAGEMENT_STATUS')%>'  aria-chosen-valid='Yes'  class='chosen-select frm-size-medium'  data-placeholder='<%$this->general->parseLabelMessage('GENERIC_PLEASE_SELECT__C35FIELD_C35' ,'#FIELD#', 'BUSINESS_MANAGEMENT_STATUS')%>'  ", "|||", "", $opt_selected,"u_status")%>
</div>
<div class="error-msg-form "><label class='error' id='u_statusErr'></label></div>
								...
								<div class="form-row row-fluid " id="cc_sh_u_log_status_updated">
                                    ...
                                    <div class="form-right-div  ">
                                        ...
                                        <%$this->dropdown->display("u_log_status_updated","u_log_status_updated","  title='<%$this->lang->line('BUSINESS_MANAGEMENT_LOG_STATUS')%>'  aria-chosen-valid='Yes'  class='chosen-select frm-size-medium'  data-placeholder='<%$this->general->parseLabelMessage('GENERIC_PLEASE_SELECT__C35FIELD_C35' ,'#FIELD#', 'BUSINESS_MANAGEMENT_LOG_STATUS')%>'  ", "|||", "", $opt_selected,"u_log_status_updated")%>
                                    </div>
...
<%/if%>
<%include file="business_management_add_buttons.tpl"%>
</div>
</div>
<div class="clear"></div>
</form>
...
callSwitchToSelf();
<%/javascript%>
<%$this->js->add_js('admin/business_management_add_js.js')%>
...
<%/if%>
<%javascript%>
Project.modules.business_management.callEvents();
<%/javascript%>
