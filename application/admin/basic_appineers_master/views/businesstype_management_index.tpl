...
<div class="module-list-container">
    <%include file="businesstype_management_index_strip.tpl"%>
...
<%javascript%>
    ...
    js_col_name_json = [{
        "name": "i_interests_image",
        "label": "<%$list_config['i_interests_image']['label_lang']%>"
    },
    {
        "name": "i_interests_name",
        "label": "<%$list_config['i_interests_name']['label_lang']%>"
    },
    {
        "name": "i_interests_status",
        "label": "<%$list_config['i_interests_status']['label_lang']%>"
    },
    {
        "name": "i_added_at",
    ...
    js_col_model_json = [{
        "name": "i_interests_image",
        "index": "i_interests_image",
        "label": "<%$list_config['i_interests_image']['label_lang']%>",
        "labelClass": "header-align-center",
        "resizable": true,
        "width": "<%$list_config['i_interests_image']['width']%>",
        "search": false,
        "export": <%if $list_config['i_interests_image']['export'] eq 'No' %>false<%else%>true<%/if%>,
        "sortable": <%if $list_config['i_interests_image']['sortable'] eq 'No' %>false<%else%>true<%/if%>,
        "hidden": <%if $list_config['i_interests_image']['hidden'] eq 'Yes' %>true<%else%>false<%/if%>,
        "hideme": <%if $list_config['i_interests_image']['hideme'] eq 'Yes' %>true<%else%>false<%/if%>,
        "addable": <%if $list_config['i_interests_image']['addable'] eq 'Yes' %>true<%else%>false<%/if%>,
        "editable": <%if $list_config['i_interests_image']['editable'] eq 'Yes' %>true<%else%>false<%/if%>,
        "align": "center",
        "edittype": "file",
        "editrules": {
            "infoArr": []
        ...
        "searchoptions": {
            "attr": {
                ...
                "aria-module-name": "businesstype_management",
                "aria-unique-name": "i_interests_image",
                "autocomplete": "off"
            },
            "sopt": strSearchOpts,
            "searchhidden": <%if $list_config['i_interests_image']['search'] eq 'Yes' %>true<%else%>false<%/if%>
        },
        "editoptions": {
            "aria-grid-id": el_tpl_settings.main_grid_id,
            "aria-module-name": "businesstype_management",
        ...
        "ctrl_type": "file",
        "default_value": "<%$list_config['i_interests_image']['default']%>",
        "filterSopt": "cn"
    },
    {
        "name": "i_interests_name",
        "index": "i_interests_name",
        "label": "<%$list_config['i_interests_name']['label_lang']%>",
        "labelClass": "header-align-left",
        "resizable": true,
        "width": "<%$list_config['i_interests_name']['width']%>",
        "search": <%if $list_config['i_interests_name']['search'] eq 'No' %>false<%else%>true<%/if%>,
        "export": <%if $list_config['i_interests_name']['export'] eq 'No' %>false<%else%>true<%/if%>,
        "sortable": <%if $list_config['i_interests_name']['sortable'] eq 'No' %>false<%else%>true<%/if%>,
        "hidden": <%if $list_config['i_interests_name']['hidden'] eq 'Yes' %>true<%else%>false<%/if%>,
        "hideme": <%if $list_config['i_interests_name']['hideme'] eq 'Yes' %>true<%else%>false<%/if%>,
        "addable": <%if $list_config['i_interests_name']['addable'] eq 'Yes' %>true<%else%>false<%/if%>,
        "editable": <%if $list_config['i_interests_name']['editable'] eq 'Yes' %>true<%else%>false<%/if%>,
        "align": "left",
        "edittype": "text",
        "editrules": {
            "required": true,
            "infoArr": {
                "required": {
                    "message": ci_js_validation_message(js_lang_label.GENERIC_PLEASE_ENTER_A_VALUE_FOR_THE__C35FIELD_C35_FIELD_C46 ,"#FIELD#",js_lang_label.businesstype_management_NAME)
                }
            }
        },
        "searchoptions": {
            "attr": {
                "aria-grid-id": el_tpl_settings.main_grid_id,
                "aria-module-name": "businesstype_management",
                "aria-unique-name": "i_interests_name",
                "autocomplete": "off"
            },
            "sopt": strSearchOpts,
            "searchhidden": <%if $list_config['i_interests_name']['search'] eq 'Yes' %>true<%else%>false<%/if%>
        },
        "editoptions": {
            "aria-grid-id": el_tpl_settings.main_grid_id,
            "aria-module-name": "businesstype_management",
        ...
        "ctrl_type": "textbox",
        "default_value": "<%$list_config['i_interests_name']['default']%>",
        "filterSopt": "bw",
    ...
    {
        "name": "i_interests_status",
        "index": "i_interests_status",
        "label": "<%$list_config['i_interests_status']['label_lang']%>",
        "labelClass": "header-align-center",
        "resizable": true,
        "width": "<%$list_config['i_interests_status']['width']%>",
        "search": <%if $list_config['i_interests_status']['search'] eq 'No' %>false<%else%>true<%/if%>,
        "export": <%if $list_config['i_interests_status']['export'] eq 'No' %>false<%else%>true<%/if%>,
        "sortable": <%if $list_config['i_interests_status']['sortable'] eq 'No' %>false<%else%>true<%/if%>,
        "hidden": <%if $list_config['i_interests_status']['hidden'] eq 'Yes' %>true<%else%>false<%/if%>,
        "hideme": <%if $list_config['i_interests_status']['hideme'] eq 'Yes' %>true<%else%>false<%/if%>,
        "addable": <%if $list_config['i_interests_status']['addable'] eq 'Yes' %>true<%else%>false<%/if%>,
        "editable": <%if $list_config['i_interests_status']['editable'] eq 'Yes' %>true<%else%>false<%/if%>,
        "align": "center",
        "edittype": "select",
        "editrules": {
            "required": true,
            "infoArr": {
                "required": {
                    "message": ci_js_validation_message(js_lang_label.GENERIC_PLEASE_ENTER_A_VALUE_FOR_THE__C35FIELD_C35_FIELD_C46 ,"#FIELD#",js_lang_label.businesstype_management_STATUS)
                }
            }
        },
        "searchoptions": {
            "attr": {
                "aria-grid-id": el_tpl_settings.main_grid_id,
                "aria-module-name": "businesstype_management",
                "aria-unique-name": "i_interests_status",
                "autocomplete": "off",
                "data-placeholder": " ",
            ...
            "sopt": intSearchOpts,
            "searchhidden": <%if $list_config['i_interests_status']['search'] eq 'Yes' %>true<%else%>false<%/if%>,
            "dataUrl": <%if $count_arr["i_interests_status"]["json"] eq "Yes" %>false<%else%>'<%$admin_url%><%$mod_enc_url["get_list_options"]%>?alias_name=i_interests_status&mode=<%$mod_enc_mode["Search"]%>&rformat=html<%$extra_qstr%>'<%/if%>,
            "value": <%if $count_arr["i_interests_status"]["json"] eq "Yes" %>$.parseJSON('<%$count_arr["i_interests_status"]["data"]|@addslashes%>')<%else%>null<%/if%>,
            "dataInit": <%if $count_arr['i_interests_status']['ajax'] eq 'Yes' %>initSearchGridAjaxChosenEvent<%else%>initGridChosenEvent<%/if%>,
            "ajaxCall": '<%if $count_arr["i_interests_status"]["ajax"] eq "Yes" %>ajax-call<%/if%>',
            "multiple": true
        },
        "editoptions": {
            "aria-grid-id": el_tpl_settings.main_grid_id,
            "aria-module-name": "businesstype_management",
            "aria-unique-name": "i_interests_status",
            "dataUrl": '<%$admin_url%><%$mod_enc_url["get_list_options"]%>?alias_name=i_interests_status&mode=<%$mod_enc_mode["Update"]%>&rformat=html<%$extra_qstr%>',
            "dataInit": <%if $count_arr['i_interests_status']['ajax'] eq 'Yes' %>initEditGridAjaxChosenEvent<%else%>initGridChosenEvent<%/if%>,
            "ajaxCall": '<%if $count_arr["i_interests_status"] eq "Yes" %>ajax-call<%/if%>',
            "data-placeholder": "<%$this->general->parseLabelMessage('GENERIC_PLEASE_SELECT__C35FIELD_C35' ,'#FIELD#', 'businesstype_management_STATUS')%>",
            "class": "inline-edit-row chosen-select"
        },
        "ctrl_type": "dropdown",
        "default_value": "<%$list_config['i_interests_status']['default']%>",
        "filterSopt": "in",
        "stype": "select"
    },
    {
