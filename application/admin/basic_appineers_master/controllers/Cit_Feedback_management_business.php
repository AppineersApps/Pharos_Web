...
Class Cit_Feedback_management_business extends Feedback_management_business {
...
{	    
        $url = $this->general->getAdminEncodeURL('basic_appineers_master/feedback_management_business/add').'|mode|'.$this->general->getAdminEncodeURL('Update').'|id|'.$this->general->getAdminEncodeURL($arr);
