...
public function checkUniqueInterest($value = ''){
    ...
    if(false == empty($value)){
      $this->db->select('iBusinessTypeId');
      $this->db->from('business');
      $this->db->where_in('iBusinessTypeId', $value);
      $arrInterestData=$this->db->get()->result_array();
      //echo $arrInterestData;exit;
...
{     
        $url = $this->general->getAdminEncodeURL('basic_appineers_master/businesstype_management/add').'|mode|'.$this->general->getAdminEncodeURL('Update').'|id|'.$this->general->getAdminEncodeURL($arr);
