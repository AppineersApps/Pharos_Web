 ...
 * 
 * @class Business_management_model.php
 * 
 * @path application\admin\basic_appineers_master\models\Business_management_model.php
 * 
 * @version 4.4
 *
 * @author CIT Dev Team
...
class Business_management_model extends CI_Model 
{
    public $table_name;
    public $table_alias;
    public $primary_key;
    ...
    public function getData($extra_cond = "", $fields = "", $order_by = "", $group_by = "", $limit = "", $join = "No", $having_cond = '', $list = FALSE)
    {
        ...
        $this->db->select("u.dtUpdatedAt AS u_updated_at");
            ...
            $this->db->join("business AS ms", "u.iUserid = ms.iUserid", "left");
            $this->db->join("business_type AS bt", "ms.iBusinessTypeid = bt.iBusinessTypeid", "left");
            $this->db->join("business_working_hours AS bw", "ms.iBusinessid = bw.iBusinessid", "left");
            $this->db->select("u.iUserId AS iUserId");
            $this->db->select("u.iUserId AS u_user_id");
            //$this->db->select("u.vProfileImage AS u_profile_image");
            $this->db->select("ms.vImage AS u_profile_image");
            $this->db->select("ms.vImage4 AS u_profile_image1");
            $this->db->select("bw.vDay AS u_day");
            //$this->db->select("u.vFirstName AS u_first_name");
            $this->db->select("ms.tAboutBusiness AS u_about_business");
            $this->db->select("ms.vBusinessName AS u_business_name");
            $this->db->select("bt.vBusinessTypeName AS u_business_type");
            $this->db->select("u.vUserName AS u_user_name");
            $this->db->select("u.vEmail AS u_email");
            $this->db->select("u.vMobileNo AS u_mobile_no");
    ...
    public function getBussinessHours($id)
    {
        try
        {
            if($id > 0)
            {
                 $this->db->from("business_working_hours");

                $this->db->select("iBusinessId,vDay,vStartAt,vCloseAt");
                $this->db->where("iBusinessId=",$id);
    ...
    public function getListingData($config_arr = array())
    {
        ...
        //$this->db->join('business as t2', 'u.iUserid = t2.iUserid', 'LEFT')
        $this->db->join("business AS ms", "u.iUserid = ms.iUserid", "left");
        $this->db->select("ms.vImage AS u_profile_image");
        //$this->db->select("concat(u.vFirstName,\"\",u.vLastName) AS u_first_name");
        $this->db->select("ms.vBusinessName AS u_first_name");
        //$this->db->select("u.vUserName AS u_user_name");
        $this->db->select("u.vEmail AS u_email");
        $this->db->select("u.vMobileNo AS u_mobile_no");
        $this->db->select("u.dtAddedAt AS u_added_at");
        ...
        $this->db->where_in("u.eUserType", 'business');
    ...
    public function getListConfiguration($name = "")
    {
        $list_config = array(
                ...
                "align" => "center",
                "label" => "Profile Image",
                "lang_code" => "BUSINESS_MANAGEMENT_PROFILE_IMAGE",
                "label_lang" => $this->lang->line('BUSINESS_MANAGEMENT_PROFILE_IMAGE'),
                "width" => 50,
                "search" => "No",
                "export" => "Yes",
                "sortable" => "No",
                ...
                "file_inline" => "Yes",
                "file_server" => "amazon",
                "file_folder" => "pharos/business_profile",
                "file_width" => "80",
                "file_height" => "80"
            ),
                "u_first_name" => array(
                ...
                "align" => "left",
                "label" => "Full Name",
                "lang_code" => "BUSINESS_MANAGEMENT_BUSINESS_NAME",
                "label_lang" => $this->lang->line('BUSINESS_MANAGEMENT_BUSINESS_NAME'),
                "width" => 50,
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
                ...
                "align" => "left",
                "label" => "Email",
                "lang_code" => "BUSINESS_MANAGEMENT_EMAIL",
                "label_lang" => $this->lang->line('BUSINESS_MANAGEMENT_EMAIL'),
                "width" => 80,
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
                ...
                "align" => "left",
                "label" => "Mobile Number",
                "lang_code" => "BUSINESS_MANAGEMENT_MOBILE_NUMBER",
                "label_lang" => $this->lang->line('BUSINESS_MANAGEMENT_MOBILE_NUMBER'),
                "width" => 50,
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
                ...
                "align" => "left",
                "label" => "Created On",
                "lang_code" => "BUSINESS_MANAGEMENT_CREATED_ON",
                "label_lang" => $this->lang->line('BUSINESS_MANAGEMENT_CREATED_ON'),
                "width" => 50,
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
                ...
                "align" => "center",
                "label" => "Status",
                "lang_code" => "BUSINESS_MANAGEMENT_STATUS",
                "label_lang" => $this->lang->line('BUSINESS_MANAGEMENT_STATUS'),
                "width" => 50,
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
                ...
                "align" => "left",
                "label" => "Updated At",
                "lang_code" => "BUSINESS_MANAGEMENT_UPDATED_AT",
                "label_lang" => $this->lang->line('BUSINESS_MANAGEMENT_UPDATED_AT'),
                "width" => 50,
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
    ...
    public function getFormConfiguration($name = "")
    {
        $form_config = array(
                ...
                "u_business_name" => array(
                "name" => "u_business_name",
                "table_name" => "business",
                "table_alias" => "ms",
                ...
                "u_business_type" => array(
                "name" => "u_business_type",
                "table_name" => "business",
                "table_alias" => "ms",
                "field_name" => "vBusinessType",
                "entry_type" => "Table",
                "data_type" => "varchar",
                "show_input" => "Both",
                "type" => "textbox",
                "label" => "Business Type",
                "lang_code" => "BUSINESS_MANAGEMENT_BUSINESS_TYPE",
                "label_lang" => $this->lang->line('BUSINESS_MANAGEMENT_BUSINESS_TYPE')
            ),
                "u_user_name" => array(
                "name" => "u_user_name",
                "table_name" => "users",
                ...
                "type" => "textbox",
                "label" => "Username",
                "lang_code" => "BUSINESS_MANAGEMENT_USERNAME",
                "label_lang" => $this->lang->line('BUSINESS_MANAGEMENT_USERNAME')
            ),
                "u_email" => array(
                "name" => "u_email",
                "table_name" => "users",
                ...
                "type" => "date",
                "label" => "Dob",
                "lang_code" => "BUSINESS_MANAGEMENT_DOB",
                "label_lang" => $this->lang->line('BUSINESS_MANAGEMENT_DOB'),
                "format" => $this->general->getAdminPHPFormats('date')
            ),
                "u_address" => array(
                "name" => "u_address",
                ...
                "type" => "google_maps",
                "label" => "Address",
                "lang_code" => "BUSINESS_MANAGEMENT_ADDRESS",
                "label_lang" => $this->lang->line('BUSINESS_MANAGEMENT_ADDRESS')
            ),
                "u_city" => array(
                "name" => "u_city",
                "table_name" => "users",
                ...
                "type" => "textbox",
                "label" => "City",
                "lang_code" => "BUSINESS_MANAGEMENT_CITY",
                "label_lang" => $this->lang->line('BUSINESS_MANAGEMENT_CITY')
            ),
                "u_state_id" => array(
                "name" => "u_state_id",
                "table_name" => "users",
                ...
                "type" => "dropdown",
                "label" => "State",
                "lang_code" => "BUSINESS_MANAGEMENT_STATE",
                "label_lang" => $this->lang->line('BUSINESS_MANAGEMENT_STATE')
            ),
                ...
                "type" => "textbox",
                "label" => "Zip Code",
                "lang_code" => "BUSINESS_MANAGEMENT_ZIP_CODE",
                "label_lang" => $this->lang->line('BUSINESS_MANAGEMENT_ZIP_CODE')
            ),
                "u_about_business" => array(
                "name" => "u_about_business",
                "table_name" => "business",
                "table_alias" => "ms",
                "field_name" => "tAboutBusiness",
                "entry_type" => "Table",
                "data_type" => "varchar",
                "show_input" => "Both",
                "type" => "textbox",
                "label" => "About Business",
                "lang_code" => "BUSINESS_MANAGEMENT_ABOUT_BUSINESS",
                "label_lang" => $this->lang->line('BUSINESS_MANAGEMENT_ABOUT_BUSINESS')
            ),
                ...
                "lang_code" => "BUSINESS_MANAGEMENT_TERMS_CONDITIONS_VERSION",
                "label_lang" => $this->lang->line('BUSINESS_MANAGEMENT_TERMS_CONDITIONS_VERSION')
            ),
                ...
                "lang_code" => "BUSINESS_MANAGEMENT_PRIVACY_POLICY_VERSION",
                "label_lang" => $this->lang->line('BUSINESS_MANAGEMENT_PRIVACY_POLICY_VERSION')
            ),
                "u_deleted_at" => array(
                "name" => "u_deleted_at",
                "table_name" => "users",
                ...
                "type" => "date",
                "label" => "Deleted At",
                "lang_code" => "BUSINESS_MANAGEMENT_DELETED_AT",
                "label_lang" => $this->lang->line('BUSINESS_MANAGEMENT_DELETED_AT'),
                "format" => $this->general->getAdminPHPFormats('date')
            ),
                "u_status" => array(
                "name" => "u_status",
                ...
                "type" => "dropdown",
                "label" => "Log Status",
                "lang_code" => "BUSINESS_MANAGEMENT_LOG_STATUS",
                "label_lang" => $this->lang->line('BUSINESS_MANAGEMENT_LOG_STATUS')
            ),
                "u_password" => array(
                "name" => "u_password",
                "table_name" => "users",
                ...
                "type" => "textbox",
                "label" => "Password",
                "lang_code" => "BUSINESS_MANAGEMENT_PASSWORD",
                "label_lang" => $this->lang->line('BUSINESS_MANAGEMENT_PASSWORD')
            ),
                "u_latitude" => array(
                "name" => "u_latitude",
                "table_name" => "users",
                ...
                "type" => "textbox",
                "label" => "Latitude",
                "lang_code" => "BUSINESS_MANAGEMENT_LATITUDE",
                "label_lang" => $this->lang->line('BUSINESS_MANAGEMENT_LATITUDE')
            ),
                "u_longitude" => array(
                "name" => "u_longitude",
                "table_name" => "users",
                ...
                "type" => "textbox",
                "label" => "Longitude",
                "lang_code" => "BUSINESS_MANAGEMENT_LONGITUDE",
                "label_lang" => $this->lang->line('BUSINESS_MANAGEMENT_LONGITUDE')
            ),
                "u_push_notify" => array(
                "name" => "u_push_notify",
                "table_name" => "users",
                ...
                "type" => "dropdown",
                "label" => "Push Notify",
                "lang_code" => "BUSINESS_MANAGEMENT_PUSH_NOTIFY",
                "label_lang" => $this->lang->line('BUSINESS_MANAGEMENT_PUSH_NOTIFY'),
                ...
                "lang_code" => "BUSINESS_MANAGEMENT_ONE_TIME_TRANSACTION",
                "label_lang" => $this->lang->line('BUSINESS_MANAGEMENT_ONE_TIME_TRANSACTION')
            ),
                ...
                "type" => "textbox",
                "label" => "Access Token",
                "lang_code" => "BUSINESS_MANAGEMENT_ACCESS_TOKEN",
                "label_lang" => $this->lang->line('BUSINESS_MANAGEMENT_ACCESS_TOKEN')
            ),
                ...
                "lang_code" => "BUSINESS_MANAGEMENT_RESET_PASSWORD_CODE",
                "label_lang" => $this->lang->line('BUSINESS_MANAGEMENT_RESET_PASSWORD_CODE')
            ),
                ...
                "lang_code" => "BUSINESS_MANAGEMENT_EMAIL_VERIFICATION_CODE",
                "label_lang" => $this->lang->line('BUSINESS_MANAGEMENT_EMAIL_VERIFICATION_CODE')
            ),
                ...
                "lang_code" => "BUSINESS_MANAGEMENT_EMAIL_VERIFIED",
                "label_lang" => $this->lang->line('BUSINESS_MANAGEMENT_EMAIL_VERIFIED'),
                ...
                "lang_code" => "BUSINESS_MANAGEMENT_SOCIAL_LOGIN_TYPE",
                "label_lang" => $this->lang->line('BUSINESS_MANAGEMENT_SOCIAL_LOGIN_TYPE')
            ),
                ...
                "lang_code" => "BUSINESS_MANAGEMENT_SOCIAL_LOGIN_ID",
                "label_lang" => $this->lang->line('BUSINESS_MANAGEMENT_SOCIAL_LOGIN_ID')
            ),
                "u_device_type" => array(
                "name" => "u_device_type",
                "table_name" => "users",
                ...
                "type" => "dropdown",
                "label" => "Device Type",
                "lang_code" => "BUSINESS_MANAGEMENT_DEVICE_TYPE",
                "label_lang" => $this->lang->line('BUSINESS_MANAGEMENT_DEVICE_TYPE')
            ),
                ...
                "type" => "textbox",
                "label" => "Device Token",
                "lang_code" => "BUSINESS_MANAGEMENT_DEVICE_TOKEN",
                "label_lang" => $this->lang->line('BUSINESS_MANAGEMENT_DEVICE_TOKEN')
            ),
                "u_added_at" => array(
                "name" => "u_added_at",
                "table_name" => "users",
                ...
                "type" => "date",
                "label" => "Added At",
                "lang_code" => "BUSINESS_MANAGEMENT_ADDED_AT",
                "label_lang" => $this->lang->line('BUSINESS_MANAGEMENT_ADDED_AT'),
                "format" => $this->general->getAdminPHPFormats('date')
            ),
                "u_updated_at" => array(
                "name" => "u_updated_at",
                ...
                "type" => "textbox",
                "label" => "Device Model",
                "lang_code" => "BUSINESS_MANAGEMENT_DEVICE_MODEL",
                "label_lang" => $this->lang->line('BUSINESS_MANAGEMENT_DEVICE_MODEL')
            ),
                "u_device_os" => array(
                "name" => "u_device_os",
                "table_name" => "users",
                ...
                "type" => "textbox",
                "label" => "Device Os",
                "lang_code" => "BUSINESS_MANAGEMENT_DEVICE_OS",
                "label_lang" => $this->lang->line('BUSINESS_MANAGEMENT_DEVICE_OS')
            )
        );
