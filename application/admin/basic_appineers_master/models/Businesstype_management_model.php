...
class Businesstype_management_model extends CI_Model
{
    public $table_name;
    public $table_alias;
    public $primary_key;
    ...
    public function __construct()
    {
        ...
        $this->table_alias = "i";
        $this->primary_key = "iBusinessTypeId";
        $this->primary_alias = "i_interests_id";
    ...
    public function getData($extra_cond = "", $fields = "", $order_by = "", $group_by = "", $limit = "", $join = "No", $having_cond = '', $list = FALSE)
    {
        ...
        elseif ($list == TRUE)
        {
            ...
            $this->db->select("i.iBusinessTypeId AS i_interests_id");
            $this->db->select("i.vBusinessTypeName AS i_interests_name");
            $this->db->select("i.vBusinessTypeImage AS i_interests_image");
            $this->db->select("i.eStatus AS i_interests_status");
            $this->db->select("i.dtAddedAt AS i_added_at");
            $this->db->select("('view') AS sys_custom_field_1", FALSE);
        }
        else
        {
            $this->db->select("i.iBusinessTypeId AS iBusinessTypeId");
            $this->db->select("i.iBusinessTypeId AS i_interests_id");
    ...
    public function getListConfiguration($name = "")
    {
        $list_config = array(
            "interest_id" => array(
                ...
                "source_field" => "i_interests_id",
                "display_query" => "i.iBusinessTypeId",
                "entry_type" => "Table",
                "data_type" => "int",
                "show_in" => "Both",
                "type" => "dropdown",
                "align" => "center",
                "label" => "Interest Id",
                "lang_code" => "Interest Id",
                "label_lang" =>"Interest Id",
                "width" => 50,
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
            ...
            "i_interests_name" => array(
                "name" => "i_interests_name",
                "table_name" => "business_type",
                "table_alias" => "i",
                "field_name" => "vBusinessTypeName",
                "source_field" => "i_interests_name",
                "display_query" => "i.vBusinessTypeName",
                "entry_type" => "Table",
                "data_type" => "varchar",
                "show_input" => "Both",
                "type" => "textbox",
                "label" => "First Name",
                "lang_code" => "BUSINESSTYPE_MANAGEMENT_NAME",
                "label_lang" => $this->lang->line('BUSINESSTYPE_MANAGEMENT_NAME'),
                "width" => 50,
            ),
            "i_interests_image" => array(
                "name" => "i_interests_image",
                "table_name" => "business_type",
                "table_alias" => "i",
                "field_name" => "vBusinessTypeImage",
                "source_field" => "i_interests_image",
                "entry_type" => "Table",
                "data_type" => "varchar",
                "show_input" => "Both",
                "type" => "file",
                "label" => "Interests Image",
                "lang_code" => "BUSINESSTYPE_MANAGEMENT_IMAGE",
                "label_lang" => $this->lang->line('BUSINESSTYPE_MANAGEMENT_IMAGE'),
                "width" => 50,
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
                ...
                "file_upload" => "Yes",
                "file_server" => "amazon",
                "file_keep" => "iBusinessTypeId",
                "file_folder" => "pharos/business_type",
                "file_width" => "80",
                "file_height" => "80",
            ...
            "i_interests_status" => array(
                ...
                "type" => "dropdown",
                "label" => "Status",
                "lang_code" => "BUSINESSTYPE_MANAGEMENT_STATUS",
                "label_lang" => $this->lang->line('BUSINESSTYPE_MANAGEMENT_STATUS'),
                "width" => 90,
            ),
            "i_added_at" => array(
                "name" => "i_added_at",
                ...
                "align" => "left",
                "label" => "Created On",
                "lang_code" => "BUSINESSTYPE_MANAGEMENT_ADDED_AT",
                "label_lang" => $this->lang->line('BUSINESSTYPE_MANAGEMENT_ADDED_AT'),
                "width" => 50,
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
            ...
            "sys_custom_field_1" => array(
                ...
                "align" => "center",
                "label" => "Edit",
                "lang_code" => "BUSINESSTYPE_MANAGEMENT_EDIT",
                "label_lang" => "Edit",
                "width" => 50,
                "search" => "No",
                "export" => "No",
