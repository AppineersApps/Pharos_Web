...
<div class="module-view-container">
    <%include file="abusive_reports_user_to_business_add_strip.tpl"%>
    <div class="<%$module_name%>" data-form-name="<%$module_name%>">
        <div id="ajax_content_div" class="ajax-content-div top-frm-spacing" >
            <input type="hidden" id="projmod" name="projmod" value="abusive_reports_user_to_business" />
            <!-- Page Loader -->
            ...
            <div id="scrollable_content" class="scrollable-content popup-content top-block-spacing ">
                <!-- Module View Block -->
                <div id="abusive_reports_user_to_business" class="frm-module-block frm-view-block frm-stand-view">
...
<%$this->js->add_js("admin/custom/abusive_reports_user_to_business.js")%>
<%if $this->input->is_ajax_request()%>
    <%$this->js->js_src()%>
<%/if%> 
<%if $this->input->is_ajax_request()%>
