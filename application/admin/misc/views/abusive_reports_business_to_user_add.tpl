...
<div class="module-form-container">
    <%include file="abusive_reports_business_to_user_add_strip.tpl"%>
    <div class="<%$module_name%>" data-form-name="<%$module_name%>">
        <div id="ajax_content_div" class="ajax-content-div top-frm-spacing" >
            <input type="hidden" id="projmod" name="projmod" value="abusive_reports_business_to_user" />
            <!-- Page Loader -->
            ...
            <div id="scrollable_content" class="scrollable-content popup-content top-block-spacing ">
                <div id="abusive_reports_business_to_user" class="frm-module-block frm-elem-block frm-stand-view">
                    <!-- Module Form Block -->
                                    ...
                                    <div class="content <%$rl_theme_arr['frm_stand_label_align']%>">
                                        <div class="form-row row-fluid " id="cc_sh_ar_reported_by">
                                            ...
                                            <div class="frm-bot-btn <%$rl_theme_arr['frm_stand_action_bar']%> <%$rl_theme_arr['frm_stand_action_btn']%> popup-footer">
                                                ...
                                                <%/if%>
                                                <%include file="abusive_reports_business_to_user_add_buttons.tpl"%>
                                            </div>
                                        </div>
                                        <div class="clear"></div>
                                    </form>
...
<%javascript%>
    ...
    callSwitchToSelf();
<%/javascript%>
<%$this->js->add_js('admin/abusive_reports_business_to_user_add_js.js')%>

<%$this->js->add_js("admin/custom/abusive_reports_business_to_user.js")%>
<%if $this->input->is_ajax_request()%>
    <%$this->js->js_src()%>
<%/if%> 
<%if $this->input->is_ajax_request()%>
...
<%/if%> 
<%javascript%>
    Project.modules.abusive_reports_business_to_user.callEvents();
<%/javascript%>