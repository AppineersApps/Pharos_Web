...
class Abusive_reports_business_to_user_model extends CI_Model
{
    public $table_name;
    public $table_alias;
    public $primary_key;
    ...
    public function __construct()
    {
        ...
        $this->primary_alias = "ar_abusive_reports_business_to_user_id";
    ...
    public function getData($extra_cond = "", $fields = "", $order_by = "", $group_by = "", $limit = "", $join = "No", $having_cond = '', $list = FALSE)
    {
        ...
        elseif ($list == TRUE)
        {
            ...
            $this->db->select("concat(rb.vBusinessName) AS rb_first_name");
        ...
        else
        {
            ...
            $this->db->select("ar.iReportedId AS ar_abusive_reports_business_to_user_id");
    ...
    public function getListingData($config_arr = array())
    {
        ...
        if ($this->primary_alias != "")
        {
         ...
         $this->db->where("ron.iUserId IS NOT NULL");
         $this->db->where("rb.iUserId IS NOT NULL");
         $this->db->where("ron.eUserType", 'user');
        $this->db->select("concat(rb.vBusinessName) AS rb_first_name");
        $this->db->select("concat(ron.vFirstName,\" \",ron.vLastName) AS ron_first_name");
        $this->db->select("ar.vReportMessage AS ar_message");
        $this->db->select("ar.dtAddedAt AS ar_added_at");
    ...
    public function getExportData($config_arr = array())
    {
        ...
        if ($this->primary_alias != "")
        {
         ...
         $this->db->where("ron.iUserId IS NOT NULL");
         $this->db->where("ron.eUserType", 'business');
        $this->db->select("concat(rb.vBusinessName) AS rb_first_name");
        $this->db->select("concat(ron.vFirstName,\" \",ron.vLastName) AS ron_first_name");
        $this->db->select("ar.vReportMessage AS ar_message");
        $this->db->select("ar.dtAddedAt AS ar_added_at");
    ...
    public function getListConfiguration($name = "")
    {
        $list_config = array(
            "rb_first_name" => array(
                ...
                "display_query" => "concat(rb.vBusinessName)",
                "entry_type" => "Table",
                "data_type" => "",
                "show_in" => "Both",
                "type" => "dropdown",
