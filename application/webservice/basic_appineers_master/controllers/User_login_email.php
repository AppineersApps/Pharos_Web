...
class User_login_email extends Cit_Controller
{
    ...
    public function start_user_login_email($request_arr = array(), $inner_api = FALSE)
    {
        try
        {
            ...
            if($input_params['user_type']=='user') #-------User Login Start-----
            {
        ...
        }#------exit-----User--- Login--- Code
        else    
        { #------Start----Business login--- Login--- Code
            $input_params = $this->prepare_where($input_params);
            ...
            if ($condition_res["success"])
            {
                ...
                $input_params = $this->get_business_login_details($input_params);
                ...
                if ($condition_res["success"])
                {
                    ...
                    if ($condition_res["success"])
                    {
                        ...
                        if ($condition_res["success"])
                        {
                            ...
                            $output_response = $this->business_finish_success_3($input_params);
                            return $output_response;
                        }
                        ...
                        else
                        {
                            ...
                            $output_response = $this->business_finish_success_4($input_params);
                            return $output_response;
                        }
                    }
     ...
     * @return array $input_params returns modfied input_params array.
     */
    public function prepare_where1($input_params = array())
    {
        if (!method_exists($this, "helperPrepareWhere1"))
        {
            $result_arr["data"] = array();
        }
        else
        {
            $result_arr["data"] = $this->helperPrepareWhere1($input_params);
        }
        $format_arr = $result_arr;
     ...
     * @return array $input_params returns modfied input_params array.
     */
    public function get_business_login_details($input_params = array())
    {
        ...
        try
        {
            ...
            $auth_token = isset($input_params["auth_token"]) ? $input_params["auth_token"] : "";
            $where_clause = isset($input_params["where_clause"]) ? $input_params["where_clause"] : "";
            $this->block_result = $this->users_model->get_business_login_details($auth_token, $where_clause);
            if (!$this->block_result["success"])
            {
                throw new Exception("No records found.");
            }
            ...
            $result_arr[$data_key]["workinghours"] = $arrShareData;
               ...
               $arrShareData1 = $this->get_product_business_details($data_arr["business_id"]);
                  ...
                  $result_arr[$data_key]["product_count"] = count($arrShareData1);
        ...
        $input_params["get_business_login_details"] = $this->block_result["data"];
        $input_params = $this->wsresponse->assignSingleRecord($input_params, $this->block_result["data"]);
     ...
     public function get_product_business_details($business_id)
    {
      ...
      $arrShareResult = array();
      $arrShareResult = $this->users_model->get_product_business_details($business_id);
       $result_arr =  $arrShareResult["data"];
      $arrShareResult['data'] = $result_arr;
      return $arrShareResult['data'] ;
    }
    ...
    public function check_business_exists($input_params = array())
    {
        ...
        try
        {
            ...
            $cc_lo_0 = (empty($input_params["get_business_login_details"]) ? 0 : 1);
            $cc_ro_0 = 1;
     ...
     * @return array $responce_arr returns responce array of api.
     */
    public function business_finish_success_3($input_params = array())
    {

        $setting_fields = array(
            "success" => "1",
            "message" => "business_finish_success_3",
        );
        $output_fields = array(
            'business_id',
            'business_type_id',
        ...
        $func_array["function"]["name"] = "business_login_email";
        $func_array["function"]["output_keys"] = $output_keys;
        $func_array["function"]["output_alias"] = $ouput_aliases;
        $func_array["function"]["single_keys"] = $this->single_keys;
        $func_array["function"]["multiple_keys"] = $this->multiple_keys;
     ...
     * @return array $responce_arr returns responce array of api.
     */
    public function business_finish_success_4($input_params = array())
    {

        $setting_fields = array(
            "success" => "0",
            "message" => "business_finish_success_4",
        );
        $output_fields = array();
     ...
     * @return array $responce_arr returns responce array of api.
     */
    public function business_finish_success_5($input_params = array())
    {

        $setting_fields = array(
            "success" => "0",
            "message" => "business_finish_success_5",
        );
        $output_fields = array();
     ...
     * @return array $responce_arr returns responce array of api.
     */
    public function business_finish_success_2($input_params = array())
    {

        $setting_fields = array(
            "success" => "0",
            "message" => "business_finish_success_2",
        );
        $output_fields = array();
