...
class Profile_visit extends Cit_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('profile_visit_model');
    }
     ...
     */
    public function rules_add_profile_visit($request_arr = array())
    {        
        $valid_arr = array(
          "business_id" => array(
                array(
        ...
        $valid_res = $this->wsresponse->validateInputParams($valid_arr, $request_arr, "add_profile_visit");
     ...
     */
    public function start_profile_visit($request_arr = array())
    {
        ...
        switch ($method) {
          ...
          case 'POST':
              $output_response =  $this->add_profile_visit($request_arr);
           return  $output_response;
             break;
   ...
   public function add_profile_visit($request_arr = array(), $inner_api = FALSE)
     {
      try
        {


            $validation_res = $this->rules_add_profile_visit($request_arr);
            ...
            $input_params = $this->set_profile_visit($input_params);
            ...
            {
                $output_response = $this->profile_visit_finish_success($input_params);
                return $output_response;
            }
            ...
            else
            {
                ...
                $output_response = $this->profile_visit_finish_success_1($input_params);
                return $output_response;
            }
            }
        catch(Exception $e)
     ...
     */
    public function set_profile_visit($input_params = array())
    {
        ...
        try
        {
            ...
            $this->block_result = $this->profile_visit_model->set_profile_visit($params_arr);
        ...
        $input_params["set_profile_visit"] = $this->block_result["data"];
     ...
     */
    public function profile_visit_finish_success($input_params = array())
    {
        $output_arr['settings']['success'] = "1";
        $output_arr['settings']['message'] = "Profile Visit added successfully";
        $output_arr['data'] = "";
        $responce_arr = $this->wsresponse->sendWSResponse($output_arr, array(), "set_profile_visit");
     ...
     * @return array $responce_arr returns responce array of api.
     */
    public function profile_visit_finish_success_success_1($input_params = array())
    {
        ...
        $func_array["function"]["name"] = "set_profile_visit";
