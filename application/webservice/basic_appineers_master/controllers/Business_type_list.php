...
class Business_type_list extends Cit_Controller
{
    ...
    {
        $valid_arr = array();
        $valid_res = $this->wsresponse->validateInputParams($valid_arr, $request_arr, "get_business_type_list");
    ...
    public function start_business_type_list($request_arr = array(), $inner_api = FALSE)
    {
        try
        {
            ...
            if ($condition_res["success"])
            {
                ...
                $output_response = $this->get_business_finish_success($input_params);
     ...
     */
    public function get_business_finish_success($input_params = array())
    {
