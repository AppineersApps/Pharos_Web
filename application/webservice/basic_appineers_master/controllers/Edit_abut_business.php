...
class Edit_about_business extends Cit_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('edit_about_business_model');
     ...
     */
    public function rules_edit_about_business($request_arr = array())
    {
        $valid_arr = array(
            "user_id" => array(
                array(
        ...
        $valid_res = $this->wsresponse->validateInputParams($valid_arr, $request_arr, "edit_about_business");
     ...
     */
    public function start_edit_about_business($request_arr = array(), $inner_api = FALSE)
    {
        try
        {
            $validation_res = $this->rules_edit_about_business($request_arr);
            ...
            $input_params = $this->checkbusinessid($input_params);
           ;
    ...
    {
        if (!method_exists($this, "checkBusinessId"))
        {
            $result_arr["data"] = array();
        }
        else
        {
            $result_arr["data"] = $this->checkBusinessId($input_params);
        }
        $format_arr = $result_arr;

        $format_arr = $this->wsresponse->assignFunctionResponse($format_arr);
        $input_params["checkBusinessId"] = $format_arr;
