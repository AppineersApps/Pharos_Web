...
class Social_login extends Cit_Controller
{
    ...
    public function start_social_login($request_arr = array(), $inner_api = FALSE)
    {
        ...
        {  ///Business Social Login
            ...
            if ($condition_res["success"])
            {
                ...
                $input_params = $this->get_business_login_details_v1_v1($input_params);

            
                $condition_res = $this->check_user_exists1($input_params);
                if ($condition_res["success"])
                {
    ...
    public function get_user_login_details_v1_v1($input_params = array())
    {
        ...
        try
        {
            ...
            $user_type = isset($input_params["user_type"]) ? $input_params["user_type"] : "";
            $this->block_result = $this->users_model->get_user_login_details_v1_v1($auth_token, $where_clause, $user_type);
     ...
     * @return array $input_params returns modfied input_params array.
     */
    public function get_business_login_details_v1_v1($input_params = array())
    {
        ...
        try
        {
            ...
            $where_clause = isset($input_params["where_clause"]) ? $input_params["where_clause"] : "";
            $user_type = isset($input_params["user_type"]) ? $input_params["user_type"] : "";
            $this->block_result = $this->users_model->get_business_login_details_v1_v1($auth_token, $where_clause, $user_type);
            if (!$this->block_result["success"])
            {
                throw new Exception("No records found.");
            }
        ...
        $input_params["get_business_login_details_v1_v1"] = $this->block_result["data"];
        $input_params = $this->wsresponse->assignSingleRecord($input_params, $this->block_result["data"]);
     ...
     * @return array $block_result returns result of condition block as array.
     */
    public function check_user_exists1($input_params = array())
    {
        ...
        try
        {
            ...
            $cc_lo_0 = (empty($input_params["get_business_login_details_v1_v1"]) ? 0 : 1);
            $cc_ro_0 = 1;
    ...
    public function business_finish_success_3($input_params = array())
    {
        ...
        $output_keys = array(
            'get_business_login_details_v1_v1',
        );
        $ouput_aliases = array(
            ...
            "b_push_notify" => "push_notify",
              "b_premium_status" => "premium_status",
               "isOpen" => "isOpen",
            //"ms_state" => "state",
        ...
        $func_array["function"]["name"] = "business_social_login";
        $func_array["function"]["output_keys"] = $output_keys;
        $func_array["function"]["output_alias"] = $ouput_aliases;
        $func_array["function"]["single_keys"] = $this->single_keys;
        $func_array["function"]["multiple_keys"] = $this->multiple_keys;
