...
class Get_near_business_v1 extends Cit_Controller
{
     ...
     public function __construct()
    {
        ...
        $this->load->model('Get_near_business_model_v1');
     ...
     */
    public function start_get_near_business_v1($request_arr = array(), $inner_api = FALSE)
    {
  		try
  		{
    ...
    public function get_near_business_list_details($input_params = array())
    {
        ...
        try
        {
            ...
            $this->block_result = $this->Get_near_business_model_v1->get_near_business_list_details($arrParams);
