...
/**
 * Description of Get Matched Users Extended Controller
 * 
 * @module Extended Get Matched Users
 * 
 * @class Cit_Get_matched_users.php
 * 
 * @path application\webservice\user\controllers\Cit_Get_matched_users.php
 * 
 * @author CIT Dev Team
 * 
 * @date 14.06.2019
...
Class Cit_Insight_the_day extends Insight_the_day {
