...
class Notification extends Cit_Controller
{
    ...
    public function get_notification($request_arr = array(), $inner_api = FALSE)
    {
        try
        {
            ...
            $output_array = $func_array = array();
              ...
              $input_params = $this->get_user_type($input_params);
     ...
     public function get_user_type($input_params = array())
    {
        $this->block_result = array();
        try
        {
            ...
            $this->block_result = $this->notification_model->get_user_type($arrResult);
        ...
        $input_params["get_user_type"] = $this->block_result["data"];
    ...
    public function get_notification_details($input_params = array())
    {
        ...
        try
        {
            ...
            $user_id=$input_params['user_id'];
            $arrResult['user_id']  = isset($input_params["user_id"]) ? $input_params["user_id"] : "";
             $arrResult['user_type']  = isset($input_params["user_type"]) ? $input_params["user_type"] : "";
               
            $this->block_result = $this->notification_model->get_notification_details($arrResult);
           ...
           if (is_array($result_arr) && count($result_arr) > 0)
            {
                ...
                foreach ($result_arr as $data_key => $data_arr)
                {
                    ...
                    $result_arr[$data_key]["image"] = $data;
