...
class Users_model extends CI_Model
{
    ...
    public function create_user($params_arr = array())
    {
        try
        {
            ...
            {
                $this->db->set("eUserType", $params_arr["user_type"]);
            }
    ...
    public function create_business($params_arr = array())
    {
        try
        {
            $result_arr = array();
...
//$this->db->select("u.tOneTimeTransaction AS t_one_time_transaction");
     ...
     * @return array $return_arr returns response of query block.
     */
    public function create_business_profile($params_arr = array())
    {
        try
        {
            $result_arr = array();
            ...
            if (isset($params_arr["business_profile"]) && !empty($params_arr["business_profile"]))
            {
                $this->db->set("vImage", $params_arr["business_profile"]);
            }
            ...
            $result_param = "business_id";
            $result_arr[0][$result_param] = $insert_id2;
            $success = 1;
        }
        catch(Exception $e)
        {
     ...
     * @return array $return_arr returns response of query block.
     */
    public function create_business_location($params_arr = array())
    {
        try
        {
            $result_arr = array();
            ...
            if (isset($params_arr["state_name"]))
            {
                $this->db->set("vState", $params_arr["state_name"]);
            }
            if (isset($params_arr["zipcode"]))
            {
                $this->db->set("vZipCode", $params_arr["zipcode"]);
             ...
             if (isset($params_arr["vCurrentTimeZone"]))
            {
                $this->db->set("current_time_zone", $params_arr["current_time_zone"]);
            }
          
            $this->db->set($this->db->protect("dCreatedOn"), $params_arr["_dtaddedat"], FALSE);
            
              $this->db->insert("business_location");
            $insert_id = $this->db->insert_id();
            if (!$insert_id)
            {
                throw new Exception("Failure in insertion.");
      ...
      public function create_business_workinghours($insert_arr=array(),$params_arr=array())
    {
        try
        {
            $result_arr = array();
            ...
            {
                $this->db->insert_batch("business_working_hours",$insert_arr);
            }
            $this->db->from("business_working_hours AS bwh");
     ...
     * @return array $return_arr returns response of query block.
     */
    public function get_business_details($insert_id = '')
    {
        try
        {
            $result_arr = array();
     ...
     * @return array $return_arr returns response of query block.
     */
    public function create_business_social($params_arr = array())
    {
        try
        {
            $result_arr = array();
     ...
     * @return array $return_arr returns response of query block.
     */
    public function get_business_login_details($auth_token = '', $where_clause = '')
    {
        try
        {
            $result_arr = array();
     ...
     * @return array $return_arr returns response of query block.
     */
    public function get_business_details_v1($user_id = '')
    {
        try
        {
            $result_arr = array();
     ...
     * @return array $return_arr returns response of query block.
     */
    public function get_business_details_v1_v1($user_id = '')
    {
        try
        {
            $result_arr = array();
            ...
            $this->db->select("u.dtAddedAt AS b_added_at");
            $this->db->select("u.dtUpdatedAt AS b_updated_at");
             $this->db->select("u.vAccessToken AS b_access_token");
            $this->db->select("u.eSocialLoginType AS b_social_login_type");
            $this->db->select("u.vSocialLoginId AS b_social_login_id");
            $this->db->select("u.ePushNotify AS b_push_notify");
     ...
     * @return array $return_arr returns response of query block.
     */
    public function update_device_details1($params_arr = array(), $where_arr = array())
    {
        try
        {
            $result_arr = array();
            if (isset($where_arr["business_id"]) && $where_arr["business_id"] != "")
            {
                $this->db->where("iBusinessId =", $where_arr["business_id"]);
            }
            if (isset($params_arr["device_type"]))
            {
                $this->db->set("eDeviceType", $params_arr["device_type"]);
     ...
     * @return array $return_arr returns response of query block.
     */
    public function get_user_login_details_v1_v1($auth_token = '', $where_clause = '', $user_type)
    {
        try
        {
            $result_arr = array();
            ...
            $this->db->select("u.eLogStatus AS u_log_status_updated");
            $this->db->where("".$where_clause."", FALSE, FALSE);
            $this->db->where("u.eUserType =", $user_type);
      ...
      public function get_business_login_details_v1_v1($auth_token = '', $where_clause = '', $user_type='')
    {
        try
        {
            $result_arr = array();
            ...
            $this->db->select("u.vSocialLoginId AS b_social_login_id");
            $this->db->select("u.ePushNotify AS b_push_notify");
           $this->db->select("u.eIsSubscribed AS b_premium_status");
            $this->db->select("b.eIsOpen AS isOpen");
            $this->db->select("u.vTermsConditionsVersion AS b_terms_conditions_version");
            $this->db->select("u.vPrivacyPolicyVersion AS b_privacy_policy_version");
            $this->db->select("u.eLogStatus AS b_log_status_updated");
     ...
     * @return array $return_arr returns response of query block.
     */
    public function update_business_status($params_arr = array())
    {
        try
        {
            ...
            if (isset($params_arr["dtUpdatedAt"]))
            {
            ...
            if (isset($params_arr["business_id"]) && $params_arr["business_id"] != "")
            {
                $this->db->where("iBusinessId =", $params_arr["business_id"]);
            }
             if (isset($params_arr["isopen"]))
            {
                $this->db->set("eIsOpen", $params_arr["isopen"]);
            }
     ...
     * @return array $return_arr returns response of query block.
     */
    public function update_business_profile($params_arr = array(), $where_arr = array())
    {
        try
        {
            $result_arr = array();
            ...
            if (isset($params_arr["business_type_id"]))
            {
             ...
             if (isset($params_arr["about_business"]))
            {
                $this->db->set("tAboutBusiness", $params_arr["about_business"]);
            }
     ...
     * @return array $return_arr returns response of query block.
     */
    public function delete_working_hours($business_id = '')
    {
        try
        {
            $result_arr = array();
            ...
            $res = $this->db->delete("business_working_hours");
            if (!$res)
            {
